    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(UpdateActivity.this, "Select a blood group!", Toast.LENGTH_SHORT).show();
                    e4.requestFocus();
                    b = false;
                    //e2.setText("");
                }
                ...
                if(s5.length()<10)
                {
                    e2.setError("Enter Valid Phone No.");
                    b = false;
                    e2.setText("");
                }
                else
